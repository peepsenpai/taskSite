    ...
    <section className="as_pricing_plan as_padderBottom20 as_padderTop80">
            <div className="container tickets">
                <div className="row">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 price-box">
                        <div className="as_pricing_box text-center">
                            ...
                            <NavLink to="#" className="as_btn btn-warning">Choose Now</NavLink>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 price-box">
                        <div className="as_pricing_box text-center">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 price-box">
                        <div className="as_pricing_box text-center">
                            <div className="as_pricing as_gradient_text">
                                <sup className="as_gradient_text">$</sup>150<sub className="as_gradient_text">/ Per Day</sub>
                            </div>
                            <h1 className="as_heading as_gradient_text">VIP Plan</h1>
                            <ul>
                                  <li>Ask One Question</li>
                                  <li>Half-Hour Reading</li>  
                                  <li className="as_inactive"> Newborn / Child <br/> Reading</li> 
